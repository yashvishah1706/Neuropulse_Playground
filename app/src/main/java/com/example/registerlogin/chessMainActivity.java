...
public class chessMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // start screen
        setContentView(R.layout.chess_activity_start);
    ...
    {
        Intent nameIntent = new Intent(chessMainActivity.this, chessNameActivity.class);
        chessMainActivity.this.startActivity(nameIntent);
    }
    ...
    public void buttonClickGame(View view)
    {
        ...
        Intent gameIntent = new Intent(chessMainActivity.this, chessGameActivity.class);
        chessMainActivity.this.startActivity(gameIntent);
    }

    public void buttonClickAbout(View view)
    {
        Intent aboutIntent = new Intent(chessMainActivity.this, chessAboutActivity.class);
        chessMainActivity.this.startActivity(aboutIntent);
    }
