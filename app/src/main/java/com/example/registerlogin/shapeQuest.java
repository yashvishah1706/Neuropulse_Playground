...
public class shapeQuest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shape_quest);
        ...
        options.add("Seventeen");
        options.add("Nine");
        options.add("Thirty");
        options.add("Eighteen");
        options.add("Eleven");
    ...
    private void endGame() {
        ...
        scoreTextView.setText("Score: " + correctCounter + "/5");
