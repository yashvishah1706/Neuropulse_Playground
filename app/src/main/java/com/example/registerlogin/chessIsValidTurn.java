...
import static com.example.registerlogin.chessTurnMethods.getColor;
import static com.example.registerlogin.chessSpecificMovingRules.*;
public class chessIsValidTurn {
